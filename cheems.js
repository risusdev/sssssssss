...
if (message.content == `${ayarlar.prefix}hazır123` && message.author.id == message.guild.ownerID) return client.channels.cache.get(ayarlar.BOTEkletmeKanalı).send(`
...
client.user.setActivity('Eklenen Botlarla',{ type: 'PLAYING'})
...
client.login("ODc4MTg5MjAzMjAzMTY2MjM5.YR9jbg.JsrhLJGfUSp17kLE__5u-_Adskw").catch(() => console.error('(node:8295) UnhandledPromiseRejectionWarning: Hata [GEÇERSİZ_TOKEN]: Geçersiz token tespit edildi.'))